...
export const PropertyList = () => {
  return (
    <div className="pList">
      ...
      <div className="pListItem">
        <img
          src="https://is1-3.housingcdn.com/4f2250e8/e60c5d0a32a40f3078ed77efc3e56d6e/v0/fs/green_ville_apartment-bankim_nagar-siliguri-green_hill_group.jpeg"
          alt=""
          className="pListImg"
        />
        <div className="pListTitles">
      ...
      <div className="pListItem">
        <img
          src="https://www.holidify.com/images/cmsuploads/compressed/149349935_20220223170425.jpg"
          alt=""
          className="pListImg"
        />
        <div className="pListTitles">
